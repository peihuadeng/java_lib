...
<div style="padding-top: 50px;width: 500px;">
	<form action="student/save" method="post" role="form" class="form-horizontal">
		...
		<div class="form-group">
			<label for="name" class="col-sm-4 control-label">学生名称:</label>
			<div class="col-sm-8">
		...
		<div class="form-group">
			<label for="teacherId" class="col-sm-4 control-label">老师ID:</label>
			<div class="col-sm-8">
				<input type="text" name="teacherId" id="teacherId" class="form-control" placeholder="请输入老师ID"
